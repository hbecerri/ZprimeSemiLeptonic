...
class ZprimeAnalysisModule_eff : public ModuleBASE {

public:
  explicit ZprimeAnalysisModule_eff(uhh2::Context&);
...
void ZprimeAnalysisModule_eff::book_histograms(uhh2::Context& ctx, vector<string> tags){
...
void ZprimeAnalysisModule_eff::fill_histograms(uhh2::Event& event, string tag){
  string mytag = tag + "_Skimming";
  mytag = tag+"_General";
...
ZprimeAnalysisModule_eff::ZprimeAnalysisModule_eff(uhh2::Context& ctx){
  //debug = true;
  debug = false;
...
bool ZprimeAnalysisModule_eff::process(uhh2::Event& event){
...
UHH2_REGISTER_ANALYSIS_MODULE(ZprimeAnalysisModule_eff)
