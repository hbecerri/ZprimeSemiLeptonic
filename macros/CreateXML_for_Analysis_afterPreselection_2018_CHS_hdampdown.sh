...
mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_common_CHS_hdampdown
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_common_CHS_hdampdown


# #MC

for sample_name in TTToSemileptonic_hdampdown_2018 TTToHadronic_hdampdown_2018 TTTo2L2Nu_hdampdown_2018 
