...
mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_common_CHS_hdampup
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_common_CHS_hdampup


# #MC

for sample_name in TTToSemileptonic_hdampup_2018 TTToHadronic_hdampup_2018 TTTo2L2Nu_hdampup_2018 
