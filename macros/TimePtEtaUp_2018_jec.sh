...
mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_CHS_common_JECup_Timepteta
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_CHS_common_JECup_Timepteta
