...
path_data=/nfs/dust/cms/group/zprime-uhh/Presel_2016/workdir_Zprime_PreSelec_2016v3_CHS_TimePtEta_down/ 

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2016v3_CHS_common_JECdown_Timepteta
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2016v3_CHS_common_JECdown_Timepteta
