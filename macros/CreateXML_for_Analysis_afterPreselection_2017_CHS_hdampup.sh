...
mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2017v2_common_CHS_hdampup
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2017v2_common_CHS_hdampup


# #MC

for sample_name in TTToSemileptonic_hdampup_2017v2 TTToHadronic_hdampup_2017v2 TTTo2L2Nu_hdampup_2017v2 
