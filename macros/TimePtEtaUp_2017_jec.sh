...
path_data=/nfs/dust/cms/group/zprime-uhh/Presel_2017/workdir_Zprime_PreSelec_2017_TimePtEta_up/ 

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2017_CHS_common_JECup_Timepteta
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2017_CHS_common_JECup_Timepteta
