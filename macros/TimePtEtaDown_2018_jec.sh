...
mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_CHS_common_JECdown_Timepteta
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2018_CHS_common_JECdown_Timepteta
